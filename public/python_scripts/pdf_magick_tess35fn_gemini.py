...
def append2f(fn_s, a_s):
    with open(fn_s, 'a') as af:
        af.write(a_s)
    return True
...
footer_s = f'\nOCR Enhanced by: {modelf_id}\nSummary Generated by: {modelp_id}\n'
with open('/tmp/urpdf/full_llm_summary.txt', 'a') as af:
    af.write(footer_s)
sshell(f'rsync -av /tmp/urpdf {fn_s}/')    
'done'
