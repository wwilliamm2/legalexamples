...
do
    ...
    ./groq4.bash ${mytxtfn}_ocr_prompt.txt llama-3.3-70b-specdec > ${mytxtfn}_llm_enhanced.txt
...
./groq4.bash /tmp/mypdf/full_summary_1_prompt.txt llama-3.3-70b-specdec > /tmp/mypdf/big_llm_1_summary.txt
...
if [ -f /tmp/mypdf/my010.pdf.png.txt_llm_enhanced.txt ]; then
    ...
    ./groq4.bash /tmp/mypdf/full_summary_2_prompt.txt llama-3.3-70b-specdec > /tmp/mypdf/big_llm_2_summary.txt
...
if [ -f /tmp/mypdf/my020.pdf.png.txt_llm_enhanced.txt ]; then
    ...
    ./groq4.bash /tmp/mypdf/full_summary_3_prompt.txt llama-3.3-70b-specdec > /tmp/mypdf/big_llm_3_summary.txt
fi
