...
# ~/lx/lx14/public/py/pdf_magick_tess20fn_groq.bash
...
# Demo:
# bash pdf_magick_tess20fn_groq.bash 34-2021-00293900-CU-OR-GDS_37_04_19_2021_Cross_Complaint_Andrews_Gabri.pdf
# bash pdf_magick_tess20fn_groq.bash 34-2021-00293900-CU-OR-GDS_36_05_21_2021_Answer_To_Cross_Complaint_Mar.pdf
# llama-3.1-8b-instant <--- uses this
...
do
    ...
    ./groq4.bash ${mytxtfn}_ocr_prompt.txt llama-3.1-8b-instant > ${mytxtfn}_llm_enhanced.txt
...
./groq4.bash /tmp/mypdf/full_summary_1_prompt.txt llama-3.1-8b-instant > /tmp/mypdf/big_llm_1_summary.txt
...
if [ -f /tmp/mypdf/my010.pdf.png.txt_llm_enhanced.txt ]; then
    ...
    ./groq4.bash /tmp/mypdf/full_summary_2_prompt.txt llama-3.1-8b-instant > /tmp/mypdf/big_llm_2_summary.txt
...
if [ -f /tmp/mypdf/my020.pdf.png.txt_llm_enhanced.txt ]; then
    ...
    ./groq4.bash /tmp/mypdf/full_summary_3_prompt.txt llama-3.1-8b-instant > /tmp/mypdf/big_llm_3_summary.txt
fi
