'''~/lx/lx14/public/py/gen_summaries13_study.py'''
...
os.environ["LANGCHAIN_PROJECT"]=f'gen_summaries13.py_{myts}'
...
# debug
for tr_fn_s in tr_fn_s_l[-5:]:
    # debug , Only a few please.
